...
export const properties: Property[] = [
  ...
  {
    id: "studio-business-bay",
    title: "Studio Loft — Business Bay Canal",
    price: "AED 1,150,000",
    area: "Business Bay",
    property_type: "Apartment",
    bedrooms: 0,
    ...
    status: "Available",
    description:
      "A smartly designed canal-front studio in the heart of Business Bay. Floor-to-ceiling glazing frames views of the Dubai Canal, with access to a full suite of hotel-style amenities — an ideal entry point for investors seeking strong rental yields.",
    image: images.apartmentInterior,
    gallery: [images.apartmentInterior, images.office],
    reference: "DA-007",
    developer: "MERAAS",
    is_featured: false,
  },
  {
    ...
    status: "Available",
    description:
      "A well-planned three-bedroom townhouse in the family-friendly community of Jumeirah Village Circle. Set within a landscaped community with parks and retail on the doorstep, offering comfortable, low-maintenance living.",
    image: images.office,
    gallery: [images.office, images.apartmentInterior],
    reference: "DA-008",
    developer: "NAKHEEL",
    is_featured: false,
  },
  {
    id: "duplex-business-bay",
    title: "Duplex Residence — Business Bay",
    price: "AED 4,300,000",
    area: "Business Bay",
    ...
    status: "Available",
    description:
      "A striking double-height duplex in a landmark Business Bay tower, featuring a private internal staircase, canal views, and premium designer finishes throughout.",
    image: images.downtownSkyline,
    gallery: [images.downtownSkyline, images.office],
    reference: "DA-009",
    developer: "DAMAC",
    is_featured: false,
  },
  {
    id: "villa-arabian-ranches",
    title: "Garden Villa — Arabian Ranches",
    price: "AED 5,900,000",
    ...
    status: "Available",
    description:
      "A charming four-bedroom villa set within the mature, tree-lined streets of Arabian Ranches. Complete with a private garden and pool, this home offers a quiet, established-community lifestyle close to championship golf.",
    image: images.golfEstate,
    gallery: [images.golfEstate, images.villaExterior],
    reference: "DA-010",
    developer: "EMAAR",
    is_featured: false,
  },
  {
    id: "apartment-downtown-1br",
    title: "One-Bedroom Residence — Downtown",
    price: "AED 2,100,000",
    area: "Downtown Dubai",
    property_type: "Apartment",
    bedrooms: 1,
    ...
    status: "Available",
    description:
      "A refined one-bedroom residence moments from The Dubai Mall and Burj Khalifa. Thoughtfully laid out with a private balcony, this address delivers Downtown prestige at an accessible price point.",
    image: images.marinaSkyline,
    gallery: [images.marinaSkyline, images.downtownSkyline],
    reference: "DA-011",
    developer: "EMAAR",
    is_featured: false,
  },
  {
    id: "townhouse-hills-estate",
    ...
    status: "Available",
    description:
      "A contemporary three-bedroom townhouse in the master-planned community of Dubai Hills Estate, with a private courtyard garden and access to parks, schools, and the Dubai Hills Golf Course.",
    image: images.waterfrontVillas,
    gallery: [images.waterfrontVillas, images.golfEstate],
    reference: "DA-012",
    developer: "EMAAR",
    is_featured: false,
  },
  {
    id: "penthouse-marina",
    title: "Marina Penthouse — Full Floor",
    ...
    status: "Available",
    description:
      "A full-floor penthouse crowning one of Dubai Marina's most recognisable towers, with wraparound terraces framing marina and sea views. Private lift access and bespoke interiors complete this exceptional residence.",
    image: images.twinTowers,
    gallery: [images.twinTowers, images.marinaSkyline],
    reference: "DA-013",
    developer: "OMNIYAT",
    is_featured: false,
  },
